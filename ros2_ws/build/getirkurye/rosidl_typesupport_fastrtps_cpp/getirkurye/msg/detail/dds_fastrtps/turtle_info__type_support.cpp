...
#include "getirkurye/msg/detail/turtle_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = getirkurye::msg::TurtleInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const getirkurye::msg::TurtleInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<getirkurye::msg::TurtleInfo *>(
    untyped_ros_message);
...
{
  return &getirkurye::msg::typesupport_fastrtps_cpp::_TurtleInfo__handle;
}
