...
static const _SetCoordinates_Request_type_support_symbol_names_t _SetCoordinates_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, getirkurye, srv, SetCoordinates_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, getirkurye, srv, SetCoordinates_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, getirkurye, srv, SetCoordinates_Request)() {
  return &::getirkurye::srv::rosidl_typesupport_c::SetCoordinates_Request_message_type_support_handle;
}
...
static const _SetCoordinates_Response_type_support_symbol_names_t _SetCoordinates_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, getirkurye, srv, SetCoordinates_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, getirkurye, srv, SetCoordinates_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, getirkurye, srv, SetCoordinates_Response)() {
  return &::getirkurye::srv::rosidl_typesupport_c::SetCoordinates_Response_message_type_support_handle;
}
...
static const _SetCoordinates_type_support_symbol_names_t _SetCoordinates_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, getirkurye, srv, SetCoordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, getirkurye, srv, SetCoordinates)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, getirkurye, srv, SetCoordinates)() {
  return &::getirkurye::srv::rosidl_typesupport_c::SetCoordinates_service_type_support_handle;
}
